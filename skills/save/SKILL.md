...
aliases:
  ...
  - key: morgen-mcp
    ...
    destination: 01-Projects/LORECRAFT-HQ/morgen-mcp.md
    ...
```
...
│ "stripe webhook" (ambiguous)  │ 01-Projects/LORECRAFT-HQ/stripe-notes.md  [stub]   │ 0.41         │
...
Anything the skill emits into `05-Tasks/` (any branch, any path under that prefix) MUST obey the plugin grammar — Nate's entire task pipeline is downstream of this file's exact shape.
