...
All five prefixes MUST be listed in the n8n W1 filter or the bot will get stuck in a self-retrigger loop. The filter is kept in `01-Projects/LORECRAFT-HQ/obsidian-tasks-sync/config/bot-prefixes.yaml` in the live vault.
