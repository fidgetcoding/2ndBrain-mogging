...
Triggered by `scheduled/launchd/io.<ORG-A>.mogging.weekly.plist` at 18:00 America/New_York on Fridays. ISO week number format (`YYYY-WW`, e.g., `2026-15`) keeps weekly reports sortable across year boundaries.
