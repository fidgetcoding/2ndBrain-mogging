...
Triggered by `scheduled/launchd/io.lorecraft.mogging.morning.plist` at 08:00 America/New_York. The agent has exactly two write targets and no others. Per `references/wiki-schema.md` §1, all reports live under `01-Projects/VAULT/conversations/reports/`.
