...
```
/plugin marketplace add <ORG-A>/2ndBrain-mogging
/plugin install 2ndbrain-mogging@<ORG-A>
```

**Manual:**

```bash
git clone https://github.com/<ORG-A>/2ndBrain-mogging.git ~/.claude/plugins/2ndbrain-mogging
```
