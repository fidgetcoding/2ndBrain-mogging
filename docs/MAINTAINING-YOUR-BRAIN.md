...
Example: there's no project called "<PERSON-I>." But if <PERSON-I> tells you something interesting about coding, that's a source — it goes in `02-Sources/`.
...
Only useful if you sync your Obsidian tasks to a calendar through an API. (the operator does this. New users often don't need it — skip it until you do.)
