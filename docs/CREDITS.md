...
- **Source:** https://github.com/ruvnet/ruflo (re-shipped through the Lorecraft fork `fidgetcoding/fidgetflo`, which was squash-imported from ruflo v3.5.80 and has since diverged)
